...
export class AuthService {
  ...
  private cognitoUser: CognitoUser & { challengeParam: { phoneNumber: string } };
  ...
  public async signIn(phoneNumber: string) {
  ...
  public async signUp(phoneNumber: string, fullName: string) {
    const params = {
